...
public class ConsolePlayer {
    ...
    public static void main(String[] args) throws IOException, ImpossibleBoardException {
        ...
        int rows = Integer.parseInt(reader.readLine().split(",")[0]);
        int cols = Integer.parseInt(reader.readLine().split(",")[1]);
                    ...
                    if (in.contains(":")) {
                        ...
                        if (in.substring(0, index).equals("start_game")) {
                            try {
                                ...
                                int row = Integer.parseInt(in.substring(index + 1, commaIndex));
                                int col = Integer.parseInt(in.substring(commaIndex + 1));
    ...
    public static void printBoard(Tile[][] board) {
        ...
        for (int r = 0; r < board.length; r++) {
            ...
            for (int c = 0; c < board[0].length; c++) {
                if (board[c][r].getFlagged()) System.out.println(" F ");
